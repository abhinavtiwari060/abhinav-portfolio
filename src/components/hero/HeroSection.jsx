  ...
  return (
    <section id="home" style={{
      ...
      <div style={{
        ...
        borderRadius: '50%', top: '-10%', left: '-5%', pointerEvents: 'none',
        background: 'radial-gradient(circle, rgba(168,85,247,0.15) 0%, transparent 70%)',
        filter: 'blur(40px)',
      }} />
      <div style={{
        position: 'absolute', width: 400, height: 400,
        borderRadius: '50%', bottom: '5%', right: '10%', pointerEvents: 'none',
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px', width: '100%' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}
          ...
          <div>
            ...
            <motion.p
              ...
              style={{ fontSize: 18, lineHeight: 1.7, color: 'rgba(255,255,255,0.55)', marginBottom: 40, maxWidth: 480 }}
            >
              {db.profile.heroBio}
            </motion.p>
            ...
            >
              ...
              <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>Let's connect</span>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            style={{ height: 500, position: 'relative' }} className="hero-orb"
          >
        ...
        >
          <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', letterSpacing: 2, textTransform: 'uppercase' }}>
            Scroll Down
          </span>
